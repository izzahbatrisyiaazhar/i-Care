...
<div class="container-fluid">
	<form action="" id="program-form">
		...
		<div class="form-group col-md-6 text-center">
					<img src="<?= validate_image(isset($image_path) ? $image_path : "") ?>" alt="Product Image" id="cimg" 
					class="border border-gray img-thumbnail">
		</div>
		<div class="form-group">
			<label for="date" class="control-label">Date</label>
			<input name="date" id="date" type="date" class="form-control form-control-sm form-control-border" 
			value="<?php echo isset($date) ? $date : ''; ?>" required>
		</div>
		<div class="form-group">
			<label for="time" class="control-label">Time</label>
			<input name="time" id="time" type="text" class="form-control form-control-sm form-control-border" 
		...
		<div class="form-group">
			...
			<textarea name="description" id="description" rows="4"class="form-control form-control-sm rounded-0 summernote" required><?php echo isset($description) ? 
